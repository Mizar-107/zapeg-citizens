...
class JobService:
    ...
    def _messages(self, job: JobRecord) -> list[dict[str, Any]]:
        ...
        system = (
            ...
            "Vanilla harvest: never pause for an axe, shovel, shears, or hoe. Wood, logs, sugar "
            "cane, bamboo, crops, leaves, dirt, sand, and gravel are hand-harvestable: punch "
            "them with empty hands and call mine on the exact block ids immediately. If a "
            "matching tool is already in inventory, equip it for speed, then mine. "
            "A missing pickaxe for stone or ore is a real blocker. "
            "When an actor answer says no tool is needed or tells you to proceed bare-handed, "
            "accept it: act immediately and never repeat that tool request. If movement leaves "
            "your position unchanged or you are standing in water, your next action is moving "
            "onto adjacent dry land before continuing the task. "
